...
def change_dist(path_dist,path_g,name_list_dir):
            ...
            for element in path.iterdir():
                if element.is_file():
                    if element.suffix=='.amr' or element.suffix=='.ogg' or element.suffix=='.wav' or element.suffix=='.mp3':
                        name_list_dir='audio'
                        change_dist(element,path,name_list_dir)
                    ...
                    elif element.suffix=='.txt' or element.suffix=='.pptx' or element.suffix=='.rtf':
                        name_list_dir='documents'
                        change_dist(element,path,name_list_dir)
